...
//try {
    ...
    $req = $connection->prepare('SELECT * FROM client WHERE id=:id');
...
?>
  ...
  <h1 class = "acueilCenter">Modification des clients</h1>

  <div style ="display: flex; justify-content: center;">
    <a type="button" class="btn btn-primary" href = "client.php">Liste des menus</a>
  </div>

  <div class = " form" >
    <form  action= " traitementclientmodifier.php?id=<?php  echo $id; ?>" method = "post" class="row g-3 needs-validation" novalidate>

      <div class="form-floating mb-3">
        <input type="texte" class="form-control" id="nom" name ="nom" placeholder="entrez votre nom" value = "<?php  echo $donnees['nom']; ?> ">
        <label for="nom">Nom</label>
      </div>

      <div class="form-floating">
        <input type="texte" class="form-control" id="prenom" name ="prenom" placeholder="Entrez le prenom" value = "<?php  echo $donnees['prenom']; ?> ">
        <label for="prenom">Prenom</label>
      </div>

      
      <div class="form-floating">
        <input type="text" class="form-control" id="contact" name ="contact" placeholder="Entrez le contact" value = "<?php  echo $donnees['contact']; ?> ">
