  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01" style="margin-left: -150px">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="GestionApropos\apropos.php">A propos</a>
        </li>
      </ul>
    ...
    <h1 class = "acueilCenter">Bienvenue chez Fastfood Benjamin le heros</h1>
<div class = "superposition">
<div>
    <h1 style = "padding-bottom: 10px; font-weight: bold"> Votre saveur à portée de clic ! </h1>
    <p style = "padding-bottom: 50px; text-align: justify">
    Découvrez une expérience culinaire rapide, savoureuse et pratique depuis le confort . Que vous soyez en quête d’un menu classique, d’une spécialité locale ou d’un repas sur-mesure, nous avons ce qu’il vous faut !
      </p>
    <div class = "boutonAligner">
      <button class = "alignerelement"><img src="Assets\image\p.png" alt="piment" class = "w-25" style = "height: 30px">DOUX</button>
      <button  style = "background-color : red;border-color: red; display: flex;gap : 10px;height: 30px;width: 100px;border-radius: 10px; color : white;"><img src="Assets\image\b.png" alt="piment" class = "w-25"style = "color:white;">EPICE</button>
      <button  class = "alignerelement"><img src="Assets\image\p.png" alt="piment" class = "w-25" style = "height: 30px">CHAUD</button>
    </div>
    <div class = "boutonAligner">
     <button  class = "aligne">Effectuer un payement</button> 
      <h1 style = "color: green;">En FCFA</h1>
    </div>
   <a href="#"> <div class = "alignerimg">
    <div class = "anima">
      <img src="Assets\image\1.png" alt="Burger" class = "w-100" style = "height: 150px">
    </div>
    <div class = "anima">
      <img src="Assets\image\2.png" alt="Burger" class = "w-100" style = "height:100px">
    </div>
    <div class = "anima">
      <img src="Assets\image\3.png" alt="Burger" class = "w-100" style = "height:100px">
    </div>
    <div class = "anima">
      <img src="Assets\image\4.png" alt="Burger" class = "w-100" style = "height:100px">
    </div>
    <div>
    </div>
  ...
  <div> <img src="Assets\image\6.png" alt="Burger" class = "w-150"></div>

  <div> <img src="Assets\image\7.png" alt="Burger" class = "w-50" style = "padding-bottom: 50px;">
  <img src="Assets\image\8.png" alt="Burger" class = "w-100" >
</div>
  </div>
<!-- 
